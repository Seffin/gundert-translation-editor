...
} from '@/lib/browser/reference-formatter';
						...
						<div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
							...
							<div className="mt-6">
								...
								<p className="text-sm text-gray-600 mb-3">
									{searchResults.tokens.length} equivalent format
									{searchResults.tokens.length !== 1 ? 's' : ''} found:
								</p>
							...
							<div className="mt-6 p-4 bg-blue-50 rounded border border-blue-200">
								...
								<ul className="text-sm text-blue-800 space-y-1">
									...
									<li>
										<strong>Mnemonic:</strong> 04400301600005 (BibleWorks format: 0 + book+1 +
										chapter + verse + word-range)
									</li>
								</ul>
							</div>
						</div>
