...
import {
	lexiconHrefWithResource,
	toggleResource,
	toggle,
	param
} from '@/lib/browser/lexicon-utils';
				...
				<div className="mb-5 flex flex-wrap items-center gap-2">
					...
					<Link
						...
						className={`rounded-full border px-3 py-1 text-xs font-medium transition ${
							activeStatuses.length === ALL_TRANSLATION_STATUSES.length &&
						...
						return (
							<Link
								...
								href={lexiconHrefWithResource(
									1,
									activeStatuses,
									toggleResource(activeResources, slug),
									queryParam
								)}
								className={`rounded-full border px-3 py-1 text-xs font-medium transition ${
									active
