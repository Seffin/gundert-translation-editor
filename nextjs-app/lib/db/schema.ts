...
export const entryRoleEnum = pgEnum('entry_role', ['translator', 'reviewer', 'admin', 'reader']);

export const feedbackTypeEnum = pgEnum('feedback_type', ['upvote', 'downvote', 'comment', 'flag']);
...
export const accounts = pgTable(
	...
	(account) => ({
		compoundKey: uniqueIndex('account_provider_key').on(account.provider, account.providerAccountId)
	})
);
